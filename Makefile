...
INPUT := input/linux-6.12.40.tar.xz
ORDERS := 1 2 3
ORDERS := 1 2 3
...
PATTERNS := (^|.*/)((Makefile|README|TODO)(\.[^/]+)?|[^/]+\.(c|h|html|json|txt|yaml))$$
...
$(INPUT): | input-dir
	curl -L -o $@ https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.12.40.tar.xz
