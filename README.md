...
This project downloads the complete source code from https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.12.38.tar.xz and processes all files with the base `Makefile`, `README`, or `TODO`; and all files with the extension `.c`, `.h`, `.html`, `.json`, `.txt`, and `.yaml`; to produce the following twelve tab-separated, LF-terminated, and UTF-8 encoded files, where {n} is 1, 2, and 3:
